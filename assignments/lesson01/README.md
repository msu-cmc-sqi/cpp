...
5. **Создание Pull Request в основной репозиторий курса**:
   - Откройте [репозиторий курса](https://github.com/msu-cmc-sqi/cpp) и сделайте fork в свой аккаунт GitHub.
   - Клонируйте свой fork и создайте отдельную ветку, например `lesson01-ivanov`.
   - Создайте в этой ветке папку `assignments/lesson01/<фамилия>/`, например `assignments/lesson01/ivanov/`.
   - Добавьте в эту папку `README.md` и кратко опишите в нём выполненные шаги по настройке рабочего окружения и работе с Git.
   - Напишите простую программу на C++, которая выводит `Hello, World!`, и добавьте её в свою папку, например как `hello.cpp`.
   - Сделайте коммит, отправьте ветку в свой fork и создайте Pull Request в основной репозиторий `msu-cmc-sqi/cpp`.
   - В описании Pull Request укажите фамилию, номер урока и кратко перечислите выполненные пункты.
